...
Click {term.green}[Q/ESC]{term.normal} to go back to start menu.
                    """)

    MAIN_ABOUT = (f"""
Footy Stats CLI has 5 main options to choose from. 
Click {term.green}[Q/ESC]{term.normal} to go back to season menu.
                """)
...
Click {term.green}[Q/ESC]{term.normal} to go back to league menu.
                    """)
...
Navigate the app using the keyboard.{term.palegreen}[Up/Down]{term.normal} moves through menu options.
...
{term.green}[UP/DOWN]{term.normal}: Navigate menu items.
{term.green}[ENTER]{term.normal}: Select the option and either display 
the data you have chosen or progress to the next menu.
{term.green}[Q/ESC]{term.normal}: Click [Q] or [ESC] on the keyboard to 
...
{term.green}[ANY KEY]{term.normal}: Progress the app
                """)
...
{term.green}Available Resources:{term.normal}
...
Data: Teams, League Table, Fixtures & Results, Top 10 Goalscorers
    ...
    ANY_KEY = f'{term.green}[ANY KEY]{term.normal}'
    Q = f'{term.green}[Q]{term.normal}'
